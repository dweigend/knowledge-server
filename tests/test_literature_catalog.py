...
from knowledge.literature_contracts import LiteratureMetadata, LiteratureRecord, Resolution
...
def test_catalog_groups_confirmed_work_identity_across_current_documents(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("knowledge.literature_catalog.list_experiments", lambda root: sources)
    ...
    monkeypatch.setattr("knowledge.literature_catalog.read_attempts", attempts)
