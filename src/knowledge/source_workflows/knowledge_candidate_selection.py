"""Retrieve revision-pinned knowledge and record explicit selections.

Selection outputs preserve scores, coverage, and chosen record revisions before
any change proposal is generated.
"""
...
class KnowledgeRetrieval(models.Contract):
...
class EntrySelection(models.Contract):
...
class KnowledgeSelection(models.Contract):
...
def retrieve_knowledge(
    query: str, records: list[models.Record], limit: int = 20
) -> KnowledgeRetrieval:
