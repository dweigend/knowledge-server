"""Detect structural issues and disagreements in extracted document content.

The checks compare blocks and tables without silently repairing or replacing
provider output.
"""
...
def compare_tables(
    primary: document_models.DocumentBlock, second_reading: document_models.DocumentBlock
) -> list[str]:
...
def _overlaps(
    primary: document_models.DocumentBlock, candidate: document_models.DocumentBlock
) -> bool:
...
def _select_table(
    primary: document_models.DocumentBlock,
    candidates: list[document_models.DocumentBlock],
    originals: list[document_models.DocumentBlock],
...
def _scan_reading(
    primary: list[document_models.DocumentBlock], reading: list[document_models.DocumentBlock]
...
def reconcile_blocks(
    primary: list[document_models.DocumentBlock],
    second_reading: list[document_models.DocumentBlock],
...
def _has_unique_match(
    candidate: document_models.DocumentBlock,
    originals: list[document_models.DocumentBlock],
    candidates: list[document_models.DocumentBlock],
) -> bool:
