"""Describe literature identities, external matches and observed citation edges."""
...
class LiteratureMetadata(PaperMetadata):
...
class LiteratureRecord(BaseModel):
    ...
    source_sha256: str
    metadata: LiteratureMetadata
    extracted: list[PaperReference] = Field(default_factory=list)
    reference_ids: list[str] = Field(default_factory=list)
