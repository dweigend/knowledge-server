"""Request structured paper extraction from a GROBID service.

HTTP execution is bounded and cancellable, and successful TEI responses are
translated through the provider-specific parser.
"""
...
from knowledge.literature import grobid_parser, structured_paper_models
...
def extract_paper(
    ...
    *,
    ...
    arguments = [
        ...
        str(timeout_seconds),
        "--max-filesize",
        str(grobid_parser.MAX_TEI_BYTES),
        "--header",
    ...
    try:
        return grobid_parser.parse_paper_tei(body.decode("utf-8"))
